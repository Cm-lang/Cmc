...
namespace Cmc.Statement
{
    public class IfStatement : WhileStatement
    {
        ...
        {
            return OkStatementList.FindReturnStatements().Concat(ElseStatementList.FindReturnStatements());
        }

        public override IEnumerable<JumpStatement> FindJumpStatements()
        {
            return OkStatementList.FindJumpStatements().Concat(ElseStatementList.FindJumpStatements());
        }
