...
namespace Cmc.Statement
{
    public class Statement : Ast
    {
        ...
        public virtual IEnumerable<ReturnStatement> FindReturnStatements()
        {
            return new List<ReturnStatement>();
        }

        public virtual IEnumerable<JumpStatement> FindJumpStatements()
        {
            return new List<JumpStatement>();
        }

        public override IEnumerable<string> Dump()
        {
            return new[] {"empty statement"};
        }
    }
    ...
    public class StatementList : Statement
    {
        ...
        public override IEnumerable<ReturnStatement> FindReturnStatements()
        {
            return Statements.SelectMany(i => i.FindReturnStatements());
        }

        public override IEnumerable<JumpStatement> FindJumpStatements()
        {
            return Statements.SelectMany(i => i.FindJumpStatements());
        }
